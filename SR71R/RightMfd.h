...
{
public:
    RightMFD(bco::PowerProvider& pwr, bco::Vessel* vessel);
...
inline RightMFD::RightMFD(bco::PowerProvider& pwr, bco::Vessel* vessel) :
    bco::MFDBase(pwr, vessel, MFD_RIGHT, 4.0)
{ }

inline void RightMFD::HandleSetClassCaps(bco::Vessel& vessel)
{
    for (auto& a : data_) {
...
inline bool RightMFD::HandleLoadVC(bco::Vessel& vessel, int vcid)
{
...
inline bool RightMFD::OnVCRedrawEvent(int id, int event, SURFHANDLE surf)
{
...
inline bool RightMFD::HandleLoadPanel(bco::Vessel& vessel, int id, PANELHANDLE hPanel)
{
...
inline bool RightMFD::OnPanelRedrawEvent(int id, int event, SURFHANDLE surf)
{

...
private:
    ...
    bco::PushButtonSwitch	switchValveOpen_        { bm::vc::LH2ValveOpenSwitch_location,     0.01 };

    bco::VCGauge            gaugeHydro_{ {bm::vc::gaHydrogenLevel_id },
                                                        bm::vc::gaHydrogenLevel_location, 
                                                        bm::vc::axisHydrogenLevel_location,
                                                        (300 * RAD), 
                                                        0.2
                                                    };
};
// Auto generated code file.  Blender: 3.0.1  Blender Tools: (2, 0, 12)
// Date: Sun Mar 13 14:24:25 2022
...
// Scene SR71r
  ...
  namespace SR71r 
  {
    ...
    const UINT ElevonPIB_id = 37;
    const UINT LeftOuterElevon_id = 38;
    const UINT OuterWings_id = 39;
    const UINT Engines_id = 40;
    const UINT RudderBase_id = 41;
    const UINT LeftRudder_id = 42;
    const UINT RightRudder_id = 43;
    const UINT EngineCone_id = 44;
    const UINT EnginesThrust_id = 45;
    const UINT EnginesFrontSkirt_id = 46;
    const UINT RightOuterElevon_id = 47;
    const UINT BayDoorPA_id = 48;
    const UINT BayDoorPF_id = 49;
    const UINT BayDoorSF_id = 50;
    const UINT BayDoorSA_id = 51;
    const UINT DockConnector_id = 52;
    const UINT ForwardCockpit_id = 53;
    const UINT ForwardCanopyWindow_id = 54;
    const UINT CockpitPanelHoodTop_id = 55;
    const UINT WindowSFI_id = 56;
    const UINT CanopyWindowInsideLeft_id = 57;
    const UINT CanopyWindowSI_id = 58;
...
// Scene SR71rVC
  ...
  namespace SR71rVC 
  {
    ...
    {-0.1300f, 0.6407f, 15.2760f, 0.0000f, 0.0000f, -1.0000f, 0.0f, 0.0f},
    {-0.1178f, 0.6407f, 15.2760f, 0.0000f, 0.0000f, -1.0000f, 0.0f, 0.0f},
    {-0.1300f, 0.6344f, 15.2760f, 0.0000f, 0.0000f, -1.0000f, 0.0f, 0.0f},
    {-0.1178f, 0.6344f, 15.2760f, 0.0000f, 0.0000f, -1.0000f, 0.0f, 0.0f}    };
    const NTVERTEX HudOrbOn_verts[4] = {
    {-0.1440f, 0.6407f, 15.2760f, 0.0000f, 0.0000f, -1.0000f, 0.0f, 0.0f},
    {-0.1318f, 0.6407f, 15.2760f, 0.0000f, 0.0000f, -1.0000f, 0.0f, 0.0f},
    {-0.1440f, 0.6344f, 15.2760f, 0.0000f, 0.0000f, -1.0000f, 0.0f, 0.0f},
    {-0.1318f, 0.6344f, 15.2760f, 0.0000f, 0.0000f, -1.0000f, 0.0f, 0.0f}    };
    const NTVERTEX HudSurfOn_verts[4] = {
    {-0.1579f, 0.6407f, 15.2760f, 0.0000f, 0.0000f, -1.0000f, 0.0f, 0.0f},
    {-0.1457f, 0.6407f, 15.2760f, 0.0000f, 0.0000f, -1.0000f, 0.0f, 0.0f},
    {-0.1579f, 0.6344f, 15.2760f, 0.0000f, 0.0000f, -1.0000f, 0.0f, 0.0f},
    {-0.1457f, 0.6344f, 15.2760f, 0.0000f, 0.0000f, -1.0000f, 0.0f, 0.0f}    };
    const NTVERTEX MsgLightSpeedBrake_verts[4] = {
    {0.0005f, 0.7462f, 15.2629f, 0.0000f, 0.0000f, -1.0000f, 0.0f, 0.0f},
    {0.0183f, 0.7462f, 15.2629f, 0.0000f, 0.0000f, -1.0000f, 0.0f, 0.0f},
    {0.0005f, 0.7406f, 15.2629f, 0.0000f, 0.0000f, -1.0000f, 0.0f, 0.0f},
    {0.0183f, 0.7406f, 15.2629f, 0.0000f, 0.0000f, -1.0000f, 0.0f, 0.0f}    };
    const NTVERTEX MsgLightAPU_verts[4] = {
    {0.0005f, 0.7527f, 15.2629f, 0.0000f, 0.0000f, -1.0000f, 0.0f, 0.0f},
    {0.0183f, 0.7527f, 15.2629f, 0.0000f, 0.0000f, -1.0000f, 0.0f, 0.0f},
    {0.0005f, 0.7471f, 15.2629f, 0.0000f, 0.0000f, -1.0000f, 0.0f, 0.0f},
    {0.0183f, 0.7471f, 15.2629f, 0.0000f, 0.0000f, -1.0000f, 0.0f, 0.0f}    };
    const NTVERTEX GlideSlopeNeedle_verts[4] = {
    {-0.0442f, 0.6010f, 15.2767f, 0.0000f, 0.0000f, -1.0000f, 0.0f, 0.0f},
    {-0.0366f, 0.6010f, 15.2767f, 0.0000f, 0.0000f, -1.0000f, 0.0f, 0.0f},
    {-0.0442f, 0.6086f, 15.2767f, 0.0000f, 0.0000f, -1.0000f, 0.0f, 0.0f},
    {-0.0366f, 0.6086f, 15.2767f, 0.0000f, 0.0000f, -1.0000f, 0.0f, 0.0f}    };
    const NTVERTEX MsgLightC2_verts[4] = {
    {-0.0182f, 0.7462f, 15.2629f, 0.0000f, 0.0000f, -1.0000f, 0.0f, 0.0f},
    {-0.0004f, 0.7462f, 15.2629f, 0.0000f, 0.0000f, -1.0000f, 0.0f, 0.0f},
    {-0.0182f, 0.7406f, 15.2629f, 0.0000f, 0.0000f, -1.0000f, 0.0f, 0.0f},
    {-0.0004f, 0.7406f, 15.2629f, 0.0000f, 0.0000f, -1.0000f, 0.0f, 0.0f}    };
    const NTVERTEX MsgLightRetro_verts[4] = {
    {-0.0370f, 0.7462f, 15.2629f, 0.0000f, 0.0000f, -1.0000f, 0.0f, 0.0f},
    {-0.0192f, 0.7462f, 15.2629f, 0.0000f, 0.0000f, -1.0000f, 0.0f, 0.0f},
    {-0.0370f, 0.7406f, 15.2629f, 0.0000f, 0.0000f, -1.0000f, 0.0f, 0.0f},
    {-0.0192f, 0.7406f, 15.2629f, 0.0000f, 0.0000f, -1.0000f, 0.0f, 0.0f}    };
    const NTVERTEX MsgLightThrustLimit_verts[4] = {
    {0.0191f, 0.7462f, 15.2629f, 0.0000f, 0.0000f, -1.0000f, 0.0f, 0.0f},
    {0.0368f, 0.7462f, 15.2629f, 0.0000f, 0.0000f, -1.0000f, 0.0f, 0.0f},
    {0.0191f, 0.7406f, 15.2629f, 0.0000f, 0.0000f, -1.0000f, 0.0f, 0.0f},
    {0.0368f, 0.7406f, 15.2629f, 0.0000f, 0.0000f, -1.0000f, 0.0f, 0.0f}    };
    const NTVERTEX MsgLightBattery_verts[4] = {
    {0.0191f, 0.7527f, 15.2629f, 0.0000f, 0.0000f, -1.0000f, 0.0f, 0.0f},
    {0.0368f, 0.7527f, 15.2629f, 0.0000f, 0.0000f, -1.0000f, 0.0f, 0.0f},
    {0.0191f, 0.7471f, 15.2629f, 0.0000f, 0.0000f, -1.0000f, 0.0f, 0.0f},
    {0.0368f, 0.7471f, 15.2629f, 0.0000f, 0.0000f, -1.0000f, 0.0f, 0.0f}    };
    const NTVERTEX MsgLightDock_verts[4] = {
    {-0.0182f, 0.7527f, 15.2629f, 0.0000f, 0.0000f, -1.0000f, 0.0f, 0.0f},
    {-0.0004f, 0.7527f, 15.2629f, 0.0000f, 0.0000f, -1.0000f, 0.0f, 0.0f},
    {-0.0182f, 0.7471f, 15.2629f, 0.0000f, 0.0000f, -1.0000f, 0.0f, 0.0f},
    {-0.0004f, 0.7471f, 15.2629f, 0.0000f, 0.0000f, -1.0000f, 0.0f, 0.0f}    };
    const NTVERTEX MsgLightCanopy_verts[4] = {
    {-0.0369f, 0.7527f, 15.2629f, 0.0000f, 0.0000f, -1.0000f, 0.0f, 0.0f},
    {-0.0192f, 0.7527f, 15.2629f, 0.0000f, 0.0000f, -1.0000f, 0.0f, 0.0f},
    {-0.0370f, 0.7471f, 15.2629f, 0.0000f, 0.0000f, -1.0000f, 0.0f, 0.0f},
    {-0.0192f, 0.7471f, 15.2629f, 0.0000f, 0.0000f, -1.0000f, 0.0f, 0.0f}    };
    const NTVERTEX MsgLightFuelWarn_verts[4] = {
    {0.0191f, 0.7591f, 15.2629f, 0.0000f, 0.0000f, -1.0000f, 0.0f, 0.0f},
    {0.0368f, 0.7591f, 15.2629f, 0.0000f, 0.0000f, -1.0000f, 0.0f, 0.0f},
    {0.0191f, 0.7535f, 15.2629f, 0.0000f, 0.0000f, -1.0000f, 0.0f, 0.0f},
    {0.0368f, 0.7535f, 15.2629f, 0.0000f, 0.0000f, -1.0000f, 0.0f, 0.0f}    };
    const NTVERTEX MsgLightKeasWarn_verts[4] = {
    {0.0004f, 0.7591f, 15.2629f, 0.0000f, 0.0000f, -1.0000f, 0.0f, 0.0f},
    {0.0182f, 0.7591f, 15.2629f, 0.0000f, 0.0000f, -1.0000f, 0.0f, 0.0f},
    {0.0004f, 0.7535f, 15.2629f, 0.0000f, 0.0000f, -1.0000f, 0.0f, 0.0f},
    {0.0182f, 0.7535f, 15.2629f, 0.0000f, 0.0000f, -1.0000f, 0.0f, 0.0f}    };
    const NTVERTEX MsgLightBay_verts[4] = {
    {-0.0183f, 0.7591f, 15.2629f, 0.0000f, 0.0000f, -1.0000f, 0.0f, 0.0f},
    {-0.0005f, 0.7591f, 15.2629f, 0.0000f, 0.0000f, -1.0000f, 0.0f, 0.0f},
    {-0.0183f, 0.7535f, 15.2629f, 0.0000f, 0.0000f, -1.0000f, 0.0f, 0.0f},
    {-0.0005f, 0.7535f, 15.2629f, 0.0000f, 0.0000f, -1.0000f, 0.0f, 0.0f}    };
    const NTVERTEX MsgLightHover_verts[4] = {
    {-0.0369f, 0.7591f, 15.2629f, 0.0000f, 0.0000f, -1.0000f, 0.0f, 0.0f},
    {-0.0192f, 0.7591f, 15.2629f, 0.0000f, 0.0000f, -1.0000f, 0.0f, 0.0f},
    {-0.0370f, 0.7535f, 15.2629f, 0.0000f, 0.0000f, -1.0000f, 0.0f, 0.0f},
    {-0.0192f, 0.7535f, 15.2629f, 0.0000f, 0.0000f, -1.0000f, 0.0f, 0.0f}    };
    ...
    const UINT CockpitPanelHood_id = 0;
    const UINT Cylinder_id = 1;
    const UINT CylinderHeading_id = 2;
    const UINT SwExoSelect_id = 3;
    const UINT SwNavSelect_id = 4;
    const UINT SwHUDMode_id = 5;
    const UINT SwRCSMode_id = 6;
    const UINT swRetroDoors_id = 7;
    const UINT swHoverDoor_id = 8;
    const UINT swShutter_id = 9;
    const UINT SwitchDockLights_id = 10;
    const UINT SwitchStrobeLights_id = 11;
    const UINT SwitchBeaconLights_id = 12;
    const UINT SwitchNavLights_id = 13;
    const UINT swDumpFuel_id = 14;
    const UINT swTransferSelect_id = 15;
    const UINT AirBrakeLever_id = 16;
    const UINT swFuelCellPower_id = 17;
    const UINT SwCargoOpen_id = 18;
    const UINT SwCanopyOpen_id = 19;
    const UINT SwCargoPower_id = 20;
    const UINT swConnectFuelCell_id = 21;
    const UINT swConnectExternalPower_id = 22;
    const UINT swThrottleLimit_id = 23;
    const UINT SwCanopyPower_id = 24;
    const UINT SwAvionics_id = 25;
    const UINT swMainPower_id = 26;
    const UINT MessagesBae_id = 27;
    const UINT CockPitPanel_id = 28;
    const UINT VCMfdRight_id = 29;
    const UINT VCMfdRightFrame_id = 30;
    const UINT VCMfdLeftFrame_id = 31;
    const UINT LGHandle_id = 32;
    const UINT CanopyFI_id = 33;
    const UINT VCMfdLeft_id = 34;
    const UINT CanopyFO_id = 35;
    const UINT SwAPUPower_id = 36;
    const UINT HUDBracketRight_id = 37;
    const UINT HUDBracketLeft_id = 38;
    const UINT ForwardCockpit_id = 39;
    const UINT LeftPanel_id = 40;
    const UINT PowerPanel_id = 41;
    const UINT HUDPanel_id = 42;
    const UINT LeftPanelControls_id = 43;
    const UINT FuelPanel_id = 44;
    const UINT CompassFace_id = 45;
    const UINT AttitudeIndicator_id = 46;
    const UINT CockpitPanelHoodTop_id = 47;
    const UINT NAVMODE_NORMAL_MINUS_id = 48;
    const UINT NAVMODE_RETRO_GRADE_id = 49;
    const UINT NAVMODE_HORZ_LEVEL_id = 50;
    const UINT NAVMODE_NORMAL_PLUS_id = 51;
    const UINT NAVMODE_PRO_GRADE_id = 52;
    const UINT AccelNeedle_id = 53;
    const UINT SwAPMACH_id = 54;
    const UINT SwAPKEAS_id = 55;
    const UINT SwAPAltitude_id = 56;
    const UINT SwAPHeading_id = 57;
    const UINT SwAPMain_id = 58;
    const UINT gaugeVoltMeter_id = 59;
    const UINT FuelCellAvailableLight_id = 60;
    const UINT ExtAvailableLight_id = 61;
    const UINT FuelCellConnectedLight_id = 62;
    const UINT ExtConnectedLight_id = 63;
    const UINT LH2SupplyOnLight_id = 64;
    const UINT FuelSupplyOnLight_id = 65;
    const UINT LOXSupplyOnLight_id = 66;
    const UINT LH2ValveOpenSwitch_id = 67;
    const UINT LOXValveOpenSwitch_id = 68;
    const UINT FuelValveOpenSwitch_id = 69;
    const UINT FuelTransferSwitch_id = 70;
    const UINT VSIOffFlag_id = 71;
    const UINT AltimeterGround_id = 72;
    const UINT AltimeterOffFlag_id = 73;
    const UINT TDIMachHund_id = 74;
    const UINT TDIMachTens_id = 75;
    const UINT TDIMachOne_id = 76;
    const UINT TDIAltTenThous_id = 77;
    const UINT TDIAltThous_id = 78;
    const UINT TDIAltHund_id = 79;
    const UINT TDIAltTens_id = 80;
    const UINT TDIAltOnes_id = 81;
    const UINT TDIKeasOnes_id = 82;
    const UINT TDIKeasTens_id = 83;
    const UINT TDIKeasHund_id = 84;
    const UINT MilesOnes_id = 85;
    const UINT MilesTens_id = 86;
    const UINT MilesHundred_id = 87;
    const UINT CrsHundreds_id = 88;
    const UINT CrsTens_id = 89;
    const UINT CrsOnes_id = 90;
    const UINT HudDockOn_id = 91;
    const UINT HudOrbOn_id = 92;
    const UINT HudSurfOn_id = 93;
    const UINT GuidanceComp_id = 94;
    ...
    const UINT ForwardWindowInsideLeft_id = 115;
    const UINT WindowSFI_id = 116;
    const UINT gaFuelFlow_id = 117;
    const UINT gaMainFuel_id = 118;
    const UINT gaRCSFuel_id = 119;
    const UINT gaugeAmpMeter_id = 120;
    const UINT ClockTimerMinute_id = 121;
    const UINT SpeedIndicatorKies_id = 122;
    const UINT MessagesLabels_id = 123;
    const UINT RoseCompass_id = 124;
    const UINT HSIBearingArrow_id = 125;
    const UINT ClockHour_id = 126;
    const UINT SpeedNeedle_id = 127;
    const UINT ClockMinute_id = 128;
    const UINT HSICourse_id = 129;
    const UINT ClockSecond_id = 130;
    const UINT HSICourseNeedle_id = 131;
    const UINT PanelHorizonFace_id = 132;
    const UINT HSIOffFlag_id = 133;
    const UINT SpeedVelocityFlag_id = 134;
    const UINT AttitudeFlagOff_id = 135;
    const UINT COMStatusPanel_id = 136;
    const UINT HSICompassHeading_id = 137;
    const UINT AOANeedle_id = 138;
    const UINT gaAlt100Needle_id = 139;
    const UINT HSIExoFlag_id = 140;
    const UINT SpeedFlagOff_id = 141;
    const UINT CanopyWindowInsideLeft_id = 142;
    const UINT CanopyWindowSI_id = 143;
    const UINT gaAlt10Needle_id = 144;
    const UINT HUD_id = 145;
    const UINT gaAlt1Needle_id = 146;
    const UINT HUDGlass_id = 147;
    const UINT CompassFaceTop_id = 148;
    const VECTOR3 SwExoSelect_location =     {-0.0383, 0.6533, 15.2735};
    const VECTOR3 SwNavSelect_location =     {0.0371, 0.6532, 15.2738};
    const VECTOR3 SwHUDMode_location =     {-0.1480, 0.6553, 15.2719};
    const VECTOR3 SwRCSMode_location =     {-0.1748, 0.6298, 15.2719};

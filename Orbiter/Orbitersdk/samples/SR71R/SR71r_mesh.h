...
// Scene SR71r2D
  ...
  namespace pnl 
  {
    ...
    {1540.6747f, 604.2291f, 0.0000f, 0.0000f, 0.0000f, -1.0000f, 0.3656f, 0.5392f},
    {1580.3617f, 604.2291f, 0.0000f, 0.0000f, 0.0000f, -1.0000f, 0.3846f, 0.5392f},
    {1540.6747f, 743.1340f, 0.0000f, 0.0000f, 0.0000f, -1.0000f, 0.3656f, 0.6072f},
    {1580.3617f, 743.1340f, 0.0000f, 0.0000f, 0.0000f, -1.0000f, 0.3846f, 0.6072f}    };
    const NTVERTEX pnlClockHour_verts[4] = {
    {1540.3906f, 603.3317f, 0.0000f, 0.0000f, 0.0000f, -1.0000f, 0.4056f, 0.5393f},
    {1580.6223f, 603.3317f, 0.0000f, 0.0000f, 0.0000f, -1.0000f, 0.4245f, 0.5393f},
    {1540.3906f, 744.1429f, 0.0000f, 0.0000f, 0.0000f, -1.0000f, 0.4056f, 0.6071f},
    {1580.6223f, 744.1429f, 0.0000f, 0.0000f, 0.0000f, -1.0000f, 0.4245f, 0.6071f}    };
    const NTVERTEX pnlClockMinute_verts[4] = {
    {1541.5426f, 607.3184f, 0.0000f, 0.0000f, 0.0000f, -1.0000f, 0.3856f, 0.5393f},
    {1579.4928f, 607.3184f, 0.0000f, 0.0000f, 0.0000f, -1.0000f, 0.4045f, 0.5393f},
    {1541.5426f, 740.1439f, 0.0000f, 0.0000f, 0.0000f, -1.0000f, 0.3856f, 0.6072f},
    {1579.4928f, 740.1439f, 0.0000f, 0.0000f, 0.0000f, -1.0000f, 0.4045f, 0.6072f}    };
    const NTVERTEX pnlClockSecond_verts[4] = {
    {1540.8712f, 605.0670f, 0.0000f, 0.0000f, 0.0000f, -1.0000f, 0.3455f, 0.5393f},
    {1580.1224f, 605.0670f, 0.0000f, 0.0000f, 0.0000f, -1.0000f, 0.3645f, 0.5393f},
    {1540.8712f, 742.4460f, 0.0000f, 0.0000f, 0.0000f, -1.0000f, 0.3455f, 0.6071f},
    {1580.1224f, 742.4460f, 0.0000f, 0.0000f, 0.0000f, -1.0000f, 0.3645f, 0.6071f}    };
    ...
    constexpr VECTOR3 pnlClockSecond_location =     {1560.4968, 673.7565, -0.0039};
    constexpr RECT pnlClockElapsedReset_RC = {1488, 720, 1515, 746};
    constexpr RECT pnlClockTimerReset_RC = {1613, 719, 1631, 737};
